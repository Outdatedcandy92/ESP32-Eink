...
FIRMWARE HAS NOT YET BEEN TESTED ON THE BOARD

Circuitpython library to use Waveshare 2.13 inch ePaper display with a ESP32-C3

* Author(s): Waveshare team, Mikko Pitkänen
* Adapted for ESP32 by: Outdatedcandy92

Implementation Notes
--------------------

This is a Circuitpython version of Waveshare 2.13" epaper display lib adapted for ESP32-C3 
based on Waveshare team's micropython class and Mikko Pitkänen's Pico W implementation.

Key differences from Pico version:
* Pin definitions changed for ESP32 GPIO
* SPI configuration adjusted for ESP32 hardware
...
* Adafruit CircuitPython firmware for ESP32-C3:
...
#define constant pins for ESP32-C3 
RST_PIN         = board.GP4
DC_PIN          = board.GP5 
CS_PIN          = board.GP6
BUSY_PIN        = board.GP3 
...
class EPD_2in13_B:
    def __init__(self, rotation):
        ...
        self.spi = busio.SPI(clock=board.GP7, MOSI=board.GP10)
